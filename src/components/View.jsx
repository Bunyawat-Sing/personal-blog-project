...
export function ViewPost() {
    ...
    return (
      <div className="flex items-center justify-center py-20">
        <div className="flex flex-col items-center">
          ...
          <p className="mt-5 text-lg font-semibold">Loading...</p>
        </div>
      </div>
    );
  }
  ...
  return (
    <div className="md:ml-44 space-y-8 md:px-8 pb-20 md:pb-28 md:pt-8 ">
      <div className="space-y-4 md:px-4">
        <img
          src={image}
          alt={title}
          className="md:h-[587px] md:w-3/4 object-cover"
        />
      </div>
          ...
          <div className="px-4 md:flex md:justify-between">
            <div>
              ...
              <div className="flex">
                ...
                <span className="px-3 py-1 text-sm font-normal ">
                ...
                <div className="space-y-4 px-4 mb-16">
                  ...
                  <div className="space-y-2">
                    <Textarea
                      ...
                      className="w-full p-4 h-24 resize-none py-3 rounded-sm "
                      onFocus={() => setIsDialogOpen(true)}
                    />
                    <div className="flex justify-end">
                      <button className="px-8 py-2 bg-black text-white rounded-full hover:bg-muted-foreground ">
                        Send
                      </button>
                    </div>
                  </div>
            ...
            <div className=" px-4 hidden md:flex md:flex-col">
              <div className="bg-[#EFEEEB] rounded-3xl p-6">
                <div className="flex items-center mb-4">
                  <div className="w-16 h-16 mr-4">
                    <img
